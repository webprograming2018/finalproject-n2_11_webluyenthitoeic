...
<%
    ...
    mediaforlisten Media  = listMediaPart3.get(0);
    Part3_4 part3_4 = listPart3.get(0);
    int dem = 0;
    int index = dem;
%>
<div class="main">
	...
	<div class="col-md-8 colQuestion" >
        ...
        <div id="fulltest_content">
            <form method="post" id="fulltest_part_head" action="<%=request.getContextPath()%>/pratice/result" data-part="part3">
                <input type="hidden" value="part3" name="part"/>
                <div  data-media="media_<%=Media.getId()%>"  class="question fullest_page_<%=index+1%> part3_<%=Media.getId()%>" data-page="<%=index+1%>"  data-id="<%=Media.getId()%>" data-part="part3">
                    ...
                    %>
                    <div  class="question  media_<%=p1.getMedia_id()%>" data-page="<%=dem+1%>"  id="test_question_<%=p1.getId()%>" data-part="3">
                ...
                <!--</div>-->
                <%
                        for (int i = 1; i < listMediaPart3.size(); i++) {
                            mediaforlisten media  = listMediaPart3.get(i); 
                            index++;
                %>
                <div  data-media="media_<%=media.getId()%> " style="display:none" class="question fullest_page_<%=index+1%> part3_<%=media.getId()%>" data-page="<%=index+1%>"  data-id="<%=media.getId()%>" data-part="part3">
                    ...
                    <%}%>
                    <% 
                        for (int idx = dem; idx < listPart3.size(); idx++) {
                            Part3_4   p1 = listPart3.get(idx);
                            dem++;
                    %>
