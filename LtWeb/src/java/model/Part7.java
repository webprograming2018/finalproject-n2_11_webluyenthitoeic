...
public class Part7 {
    ...
    public Part7(HashMap<String, String> cols) {
    ...
    public static ArrayList<Level> levelPart(){
        ArrayList<Part7> part = (ArrayList<Part7>) new DB("part7", "Part7").groupBy("level_id").get();
    ...
    public static  ArrayList<String> listAnswer(ArrayList<Part7> get) {
