...
<div class="main">
	...
	<div class="col-md-8 colQuestion" >
        ...
        <div id="fulltest_content">
            <%     
                ArrayList<Part2> listPart1 = (ArrayList<Part2>) request.getAttribute("part2"); 
                Part2 part1 = listPart1.get(0);
                int dem = 0;
            %>
            <form method="post" id="fulltest_part_head" action="<%=request.getContextPath()%>/pratice/result" data-part="part2">
                <input type="hidden" value="part2" name="part"/>
                    <div class="question fullest_page_<%=dem+1%> part1_<%=dem+1%>" data-page="1"  id="test_question_<%=part1.getId()%>" data-part="part2">
                    ...
                    <% 
                        for (int idx = 1; idx < listPart1.size(); idx++) {
                            Part2   p1 = listPart1.get(idx);
                            dem++;
                    %>
                    <div  style="display:none" class="question fullest_page_<%=dem+1%> part1_<%=dem+1%>" data-page="<%=dem+1%>"  id="test_question_<%=part1.getId()%>" data-part="part2">
                        <div class="text-center" >
                            <audio controls>
